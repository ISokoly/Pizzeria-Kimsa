...
mat-list-item {
    ...
    color: white;
    /* Rojo tomate para el texto */

    mat-icon {
        color: white;
        /* Rojo tomate para los íconos */
    }
    ...
    &:hover {
        ...
        /* Fondo suave de rojo cuando se pasa el cursor */
        border-color: white;
        /* Borde rojo cuando se pasa el cursor */
    }
}
...
.selected-menu-item {
    ...
    /* Borde rojo tomate al seleccionar */
